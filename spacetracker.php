...
<body>
    ...
    <header>
        ...
        <div>
            <img style="margin-top:2em;  " src="https://jolypaul.com/res/spacetracker/wallpaper.jpg" alt="">
        </div>
        ...
        <div style="padding-bottom:2em;" class="container25">
            <div class="infogrid">
                <div>
                    ...
                    <p style="color:white;font-size: 18px; font-weight: 600;">2021 February-March</p>
                </div>
                ...
                <div>
                    ...
                    <p style="color:white;font-size: 18px; font-weight: 600;">UI/UX Design, Ideation, 3D modelling, HTML, CSS, JS, C# </p>
                </div>

                <div>
                    <h4 style="margin-bottom: 5px;">TOOLS</h4>
                    <p style="color:white;font-size: 18px; font-weight: 600;">Adobe XD, Unity, Visual Studio Code</p>
                </div>
            </div>
        </div>
    </header>
    ...
    <div style="margin-top:3em;" class="container25">
        ...
        <nav>
            <a href="https://spacetracker.fr/" target="_blank" style="margin-top: 1em; background-color: black;  display:block; width: 10em; border-radius: 10px; text-align:center;" href="#top">SpaceTracker.fr</a>
        </nav>


        <h2 style="margin-top:2em;">Description</h2>

        <p style=" margin-top:1em;">In this 3D simulation, you will be able to discover
            the space missions of the CNES (Centre national d'études spatiales) in progress,
            as well as those in which it participated. Frequently, missions will be added!</p>
